...
type Registrar interface {
	...
	OnAttemptStarted(Policy, Handler[lifecycle.AttemptStarted])
	OnDirectiveResolved(Policy, Handler[lifecycle.DirectiveResolved])
	OnDirectiveFailed(Policy, Handler[lifecycle.DirectiveFailed])
	OnMetadataBound(Policy, Handler[lifecycle.MetadataBound])
	OnMetadataChanged(Policy, Handler[lifecycle.MetadataChanged])
	...
	OnAttemptFinished(Policy, Handler[lifecycle.AttemptFinished])

...
func ToProxyExchangeRecordDTO(record exchange.Record) ProxyExchangeRecordDTO {
	return ProxyExchangeRecordDTO{
		...
		DirectiveMode:             record.DirectiveMode,
		DirectiveBackend:          record.DirectiveBackend,
		DirectiveEndpoint:         record.DirectiveEndpoint,
		DirectiveKey:              record.DirectiveKey,
		DirectiveResolutionMillis: record.DirectiveResolutionMillis,

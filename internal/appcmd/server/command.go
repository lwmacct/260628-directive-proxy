...
func commandFlags() []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{Name: "proxy.listen", Usage: flagHelp.MustUsage("proxy.listen"), Value: defaults.Proxy.Listen},
		...
		&cli.IntFlag{Name: "proxy.capture.capacity", Usage: flagHelp.MustUsage("proxy.capture.capacity"), Value: defaults.Proxy.Capture.Capacity},
		&cli.Int64Flag{Name: "proxy.capture.max-body-bytes", Usage: flagHelp.MustUsage("proxy.capture.max-body-bytes"), Value: defaults.Proxy.Capture.MaxBodyBytes},

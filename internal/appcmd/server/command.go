...
func commandFlags() []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{Name: "proxy.capture.fluent.network", Usage: flagHelp.MustUsage("proxy.capture.fluent.network"), Value: defaults.Proxy.Capture.Fluent.Network},
		&cli.StringFlag{Name: "proxy.capture.fluent.host", Usage: flagHelp.MustUsage("proxy.capture.fluent.host"), Value: defaults.Proxy.Capture.Fluent.Host},
		&cli.IntFlag{Name: "proxy.capture.fluent.port", Usage: flagHelp.MustUsage("proxy.capture.fluent.port"), Value: defaults.Proxy.Capture.Fluent.Port},
		&cli.StringFlag{Name: "proxy.capture.fluent.socket-path", Usage: flagHelp.MustUsage("proxy.capture.fluent.socket-path"), Value: defaults.Proxy.Capture.Fluent.SocketPath},
		...
		&cli.DurationFlag{Name: "proxy.capture.fluent.timeout", Usage: flagHelp.MustUsage("proxy.capture.fluent.timeout"), Value: defaults.Proxy.Capture.Fluent.Timeout},
		...
		&cli.DurationFlag{Name: "proxy.capture.fluent.read-timeout", Usage: flagHelp.MustUsage("proxy.capture.fluent.read-timeout"), Value: defaults.Proxy.Capture.Fluent.ReadTimeout},
		&cli.IntFlag{Name: "proxy.capture.fluent.retry-wait-millis", Usage: flagHelp.MustUsage("proxy.capture.fluent.retry-wait-millis"), Value: defaults.Proxy.Capture.Fluent.RetryWaitMillis},
		&cli.IntFlag{Name: "proxy.capture.fluent.max-retry", Usage: flagHelp.MustUsage("proxy.capture.fluent.max-retry"), Value: defaults.Proxy.Capture.Fluent.MaxRetry},
		&cli.IntFlag{Name: "proxy.capture.fluent.max-retry-wait-millis", Usage: flagHelp.MustUsage("proxy.capture.fluent.max-retry-wait-millis"), Value: defaults.Proxy.Capture.Fluent.MaxRetryWaitMillis},
		...
		&cli.BoolFlag{Name: "proxy.capture.fluent.request-ack", Usage: flagHelp.MustUsage("proxy.capture.fluent.request-ack"), Value: defaults.Proxy.Capture.Fluent.RequestAck},

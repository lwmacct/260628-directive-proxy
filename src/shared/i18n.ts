...
const zh = {
  ...
  exchanges: {
    ...
    target: "目标地址", requestBody: "请求正文", responseBody: "响应正文", requestHeaders: "入站请求头", outboundRequestHeaders: "出站请求头",
...
const en: Text = {
  ...
  exchanges: {
    ...
    target: "Target", requestBody: "Request body", responseBody: "Response body", requestHeaders: "Inbound request headers", outboundRequestHeaders: "Outbound request headers",

...
const zh = {
  ...
  authConsole: {
    ...
    programModules: "有序 Module Program", programModulesDescription: "数组顺序是所有当前活跃 Module 的全局执行顺序；Exchange scope 跨越全部 Attempt，Attempt scope 每次上游访问重新创建。",
    moduleScope: "Scope", exchangeScope: "Exchange", attemptScope: "Attempt",
...
const en: Text = {
  ...
  authConsole: {
    ...
    programModules: "Ordered Module Program", programModulesDescription: "Array order is global across all active Modules. Exchange scope spans every Attempt; Attempt scope opens fresh for each upstream access.",
    moduleScope: "Scope", exchangeScope: "Exchange", attemptScope: "Attempt",

...
const zh = {
  ...
  authConsole: {
    directiveConsole: "Directive Console", directiveConsoleDescription: "构建、编码并调试 Inline 与 Remote Directive。", remoteSpecJSON: "RemoteSpec JSON",
    ...
    tokenSecret: "Token Secret", tokenSecretPlaceholder: "输入 HMAC PSK", tokenSecretRequired: "Token Secret 不能为空", tokenAuthenticationFailed: "Token HMAC 校验失败",
...
const en: Text = {
  ...
  authConsole: {
    directiveConsole: "Directive Console", directiveConsoleDescription: "Build, encode, and debug Inline and Remote Directives.", remoteSpecJSON: "RemoteSpec JSON",
    ...
    tokenSecret: "Token Secret", tokenSecretPlaceholder: "Enter the HMAC PSK", tokenSecretRequired: "Token Secret is required", tokenAuthenticationFailed: "Token HMAC verification failed",

...
const zh = {
  ...
  authConsole: {
    ...
    structured: "结构化编辑", editableSources: "可编辑输入源", directiveSource: "指令来源", redisKey: "Redis Key", optionalRemoteKey: "远程 Key（可选）", httpResolverURL: "HTTP Resolver URL", redisURL: "Redis URL", resolverHeaders: "Resolver 静态请求头", addResolverHeader: "添加请求头", removeResolverHeader: "删除 Resolver 请求头", enabled: "启用", headerOps: "Header 操作",
    ...
    tokenPrefix: "Token 必须是 dproxy.13.i 或 dproxy.13.r 格式", tokenPayloadMissing: "Token 缺少 payload", tokenDecodeFailed: "Token payload 解码失败", invalidRedisKey: "远程 Key 必须是 1-256 字节且不能包含首尾空白或控制字符", invalidRemoteURL: "远程 URL 与所选类型不匹配", invalidResolverHeader: "Resolver 请求头名称或值不合法",

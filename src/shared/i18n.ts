...
const zh = {
  ...
  directiveConsole: {
    ...
    remoteUUID: "Remote UUID", invalidRemoteUUID: "Remote UUID 必须是合法 UUID", redisKey: "Redis Key", httpResolverURL: "HTTP Resolver URL", redisURL: "Redis URL", filePath: "根目录内文件路径",
...
const en: Text = {
  ...
  directiveConsole: {
    ...
    remoteUUID: "Remote UUID", invalidRemoteUUID: "Remote UUID must be a valid UUID", redisKey: "Redis key", httpResolverURL: "HTTP resolver URL", redisURL: "Redis URL", filePath: "File path under configured root",

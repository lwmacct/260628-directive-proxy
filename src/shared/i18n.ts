...
const zh = {
  ...
  authConsole: {
    ...
    programModules: "有序 Module Program", programModulesDescription: "数组顺序是所有当前活跃 Module 的全局执行顺序；每个 Module 的生命周期由其 Definition 静态声明。",
    ...
    controllerModule: "Controller Module", controllerConfig: "Controller Config JSON", invalidControllerConfig: "Controller Config 必须是有效 JSON",
    ...
    tokenPrefix: "Token 必须使用 dp.21.inline/remote 格式", tokenDecodeFailed: "Token JSON Base64URL 解码失败", invalidRedisKey: "Redis Key 必须是 1-256 字节且不能包含首尾空白或控制字符", invalidFilePath: "File path 必须是根目录内的 slash 相对路径，不能包含 .、.. 或反斜杠，且不能超过 4096 字节", invalidResolverHeader: "请求头名称或值不合法",
...
const en: Text = {
  ...
  authConsole: {
    ...
    programModules: "Ordered Module Program", programModulesDescription: "Array order is global across all active Modules. Each Module Definition declares its lifetime statically.",
    ...
    controllerModule: "Controller Module", controllerConfig: "Controller Config JSON", invalidControllerConfig: "Controller Config must be valid JSON",

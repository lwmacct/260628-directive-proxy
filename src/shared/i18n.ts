...
const zh = {
  ...
  authConsole: {
    ...
    tokenPrefix: "Token 必须使用 dp.18.inline/remote 格式", tokenDecodeFailed: "Token JSON Base64URL 解码失败", invalidRedisKey: "Redis Key 必须是 1-256 字节且不能包含首尾空白或控制字符", invalidFilePath: "File path 必须是根目录内的 slash 相对路径，不能包含 .、.. 或反斜杠，且不能超过 4096 字节", invalidResolverHeader: "请求头名称或值不合法",
